...
export default function ShippingForm({ shipping, setShipping, onContinue }) {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-sm font-semibold mb-4">{t('checkout.shippingInfo')}</h2>
      <div className="grid grid-cols-2 gap-3">
        ...
        <Field label={t('checkout.phone')} value={shipping.phone} onChange={e => setShipping(s => ({ ...s, phone: e.target.value }))} placeholder="+212 600 000000" />
        <div className="col-span-2">
