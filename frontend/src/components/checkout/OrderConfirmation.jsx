  ...
  return (
    <div className="max-w-md mx-auto px-4 py-20 text-center">
      ...
      <p className="text-sm text-gray-500 mb-1">
        Order: <span className="font-mono font-semibold text-black dark:text-white">{orderNumber}</span>
      </p>
      <p className="text-xs text-gray-400 mb-6">Confirmation sent to {email}</p>
